...
| **Android app** | `android/app/build.gradle.kts` | `0.7.0-experimental.rc.4+core.<crate>` | An APK at an earlier maturity than the Termux client. Its own track, with the client version it embeds recorded as semver build metadata. |
