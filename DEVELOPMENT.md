...
Build environment, architecture, and test plan for OTRv4+ as of v10.13.2.
...
# expected: 87 passed; 0 failed  (as of v10.13.2)
```
...
# expected: 1992 passed, 43 skipped, 1 xfailed   (as of v10.13.2)
```
