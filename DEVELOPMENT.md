...
Build environment, architecture, and test plan for OTRv4+ as of v10.13.1.
...
# expected: 77 passed; 0 failed  (as of v10.13.1)
```
...
# expected: 1932 passed, 43 skipped, 1 xfailed   (as of v10.13.1)
```
